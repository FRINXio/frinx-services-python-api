...
class QueryResourcesData(BaseModel):
    query_resources: typing.Optional[list[ResourcePayload]] = Field(alias='QueryResources')
...
class QueryResourcePoolsData(BaseModel):
    query_resource_pools: typing.Optional[list[ResourcePoolPayload]] = Field(alias='QueryResourcePools')
...
class QueryRootResourcePoolsData(BaseModel):
    query_root_resource_pools: typing.Optional[list[ResourcePoolPayload]] = Field(alias='QueryRootResourcePools')
...
class QueryLeafResourcePoolsData(BaseModel):
    query_leaf_resource_pools: typing.Optional[list[ResourcePoolPayload]] = Field(alias='QueryLeafResourcePools')
...
class SearchPoolsByTagsData(BaseModel):
    search_pools_by_tags: typing.Optional[list[ResourcePoolPayload]] = Field(alias='SearchPoolsByTags')
...
class PoolCapacityPayload(Payload):
    free_capacity: typing.Optional[Boolean] = Field(response='Float', alias='freeCapacity', default=False)
    utilized_capacity: typing.Optional[Boolean] = Field(response='Float', alias='utilizedCapacity', default=False)


class PoolCapacityPayloadPayload(BaseModel):
    free_capacity: typing.Optional[typing.Optional[Float]] = Field(alias='freeCapacity')
    utilized_capacity: typing.Optional[typing.Optional[Float]] = Field(alias='utilizedCapacity')
