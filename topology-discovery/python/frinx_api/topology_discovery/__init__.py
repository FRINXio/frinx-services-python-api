...
PhyDevicesQueryResponse.update_forward_refs()
PhyDevicesData.update_forward_refs()
NetDevicesQueryResponse.update_forward_refs()
NetDevicesData.update_forward_refs()
NetRoutingPathsQueryResponse.update_forward_refs()
NetRoutingPathsData.update_forward_refs()
TopologyDiffQueryResponse.update_forward_refs()
TopologyDiffData.update_forward_refs()
CommonNodesQueryResponse.update_forward_refs()
...
DeleteBackupsMutationResponse.update_forward_refs()
DeleteBackupsData.update_forward_refs()
UpdateCoordinatesMutationResponse.update_forward_refs()
UpdateCoordinatesData.update_forward_refs()
UpdateNodeStatusMutationResponse.update_forward_refs()
UpdateNodeStatusData.update_forward_refs()
SyncMutationResponse.update_forward_refs()
