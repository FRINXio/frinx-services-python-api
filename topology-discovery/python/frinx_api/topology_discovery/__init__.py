...
#   filename:  <stdin>
#   timestamp: 2024-12-02T13:04:22+00:00
...
class NetDevice(Node):
    ...
    typename__: Optional[Literal['NetDevice']] = Field('NetDevice', alias='__typename') # type: ignore[assignment]
...
class PhyDevice(Node):
    ...
    typename__: Optional[Literal['PhyDevice']] = Field('PhyDevice', alias='__typename') # type: ignore[assignment]
...
class PtpDevice(Node):
    ...
    typename__: Optional[Literal['PtpDevice']] = Field('PtpDevice', alias='__typename') # type: ignore[assignment]
